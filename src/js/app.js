...
function iniciarApp(){
    ...
    idCliente(); // Añade el nombre del cliente al objeto
...
// No sabes cuanto tiempo va a tardar usa el tiempo que necesite
...
function mostrarServicios( servicios ){
    ...
    servicios.forEach( servicio => {
        ...
        servicioDiv.onclick = function (){ // CallBack Function
...
function mostrarResumen(){
    ...
    const dia = fechaObj.getDate() + 2; // Desfase de 2 dias porque se va usar dos veces
...
async function reservarCita(){
    ...
    // Array Method, Itera en el arreglo y devuelve las coincidencias
